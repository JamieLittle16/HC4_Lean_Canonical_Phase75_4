...
// Module: HC4.Newton.TerminalScalarGradient
// Imports: Init HC4.Newton.TerminalConformalFace HC4.Newton.TerminalCollision Mathlib.LinearAlgebra.Matrix.NonsingularInverse Mathlib.RingTheory.MvPolynomial.EulerIdentity Mathlib.Tactic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_HC4_Newton_TerminalScalarGradient(uint8_t builtin, lean_object* w) {
lean_object * res;
