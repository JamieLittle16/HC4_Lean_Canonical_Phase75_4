...
// Module: HC4.Newton.Equivariance
// Imports: Init HC4.Newton.ExposedFaces HC4.Toric.BranchReversal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_HC4_Newton_Equivariance(uint8_t builtin, lean_object* w) {
lean_object * res;
