...
// Module: HC4.Valuation.AdaptiveDegreeTwoKernelActivity
...
LEAN_EXPORT lean_object* initialize_HC4_Valuation_AdaptiveDegreeTwoKernelActivity(uint8_t builtin, lean_object* w) {
lean_object * res;
