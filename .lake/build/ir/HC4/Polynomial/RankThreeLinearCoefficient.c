...
// Module: HC4.Polynomial.RankThreeLinearCoefficient
...
LEAN_EXPORT lean_object* initialize_HC4_Polynomial_RankThreeLinearCoefficient(uint8_t builtin, lean_object* w) {
lean_object * res;
