import HC4.Valuation.AdaptiveAlignedSmithCanonicalZeroStrictLowFirstNonfacetOtherFacetPrUnitFiniteStaircaseCrossRoofSourceData
import HC4.Polynomial.RankThreeAffineSupportRealisation
import Mathlib.Tactic

/-!
# Source-honest coordinate control on an exposed unit cross-roof face

The exact lower-hull equation makes either transverse source coordinate a
valid parameter on the exposed unit cross-roof face.  We record the two
...
/-- Coordinate `1` is injective on the exact exposed unit face. -/
...
/-- Coordinate `2` is likewise injective on the exact exposed unit face. -/
