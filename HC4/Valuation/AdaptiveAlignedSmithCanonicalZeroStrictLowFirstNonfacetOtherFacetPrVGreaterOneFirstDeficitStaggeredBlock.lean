...
/-- Exact field-level bridge for the left active-middle entry.  This is
kept next to the staggered representation so downstream files never need to
unfold the four-block packaging. -/
theorem firstDeficitLeftStaggeredBlock_d_eq_parameterFirstHessian :
    G.firstDeficitLeftStaggeredBlock.d =
      parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 1 := by
  change G.firstDeficitLeftStaggeredMatrix (1 : Fin 4) 1 =
    parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 1
  change parameterFirstHessian P.centralDeficitFamily
      (firstDeficitLeftStaggeredPerm (1 : Fin 4))
      (firstDeficitLeftStaggeredPerm (1 : Fin 4)) =
    parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 1
  rw [firstDeficitLeftStaggeredPerm_one]

/-- Exact field-level bridge for the left mixed entry. -/
theorem firstDeficitLeftStaggeredBlock_s_eq_parameterFirstHessian :
    G.firstDeficitLeftStaggeredBlock.s =
      parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 2 := by
  change G.firstDeficitLeftStaggeredMatrix (1 : Fin 4) 3 =
    parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 2
  change parameterFirstHessian P.centralDeficitFamily
      (firstDeficitLeftStaggeredPerm (1 : Fin 4))
...
/-- Exact field-level bridge for the left missing diagonal. -/
theorem firstDeficitLeftStaggeredBlock_z_eq_parameterFirstHessian :
    G.firstDeficitLeftStaggeredBlock.z =
      parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 2 := by
  change G.firstDeficitLeftStaggeredMatrix (3 : Fin 4) 3 =
    parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 2
  change parameterFirstHessian P.centralDeficitFamily
      (firstDeficitLeftStaggeredPerm (3 : Fin 4))
      (firstDeficitLeftStaggeredPerm (3 : Fin 4)) =
    parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 2
...
/-- Exact field-level bridge for the right active-middle entry. -/
theorem firstDeficitRightStaggeredBlock_d_eq_parameterFirstHessian :
    G.firstDeficitRightStaggeredBlock.d =
      parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 2 := by
  change G.firstDeficitRightStaggeredMatrix (1 : Fin 4) 1 =
    parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 2
  change parameterFirstHessian P.centralDeficitFamily
...
/-- Exact field-level bridge for the right mixed entry. -/
theorem firstDeficitRightStaggeredBlock_s_eq_parameterFirstHessian :
    G.firstDeficitRightStaggeredBlock.s =
      parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 1 := by
  change G.firstDeficitRightStaggeredMatrix (1 : Fin 4) 3 =
    parameterFirstHessian P.centralDeficitFamily (2 : Fin 4) 1
  change parameterFirstHessian P.centralDeficitFamily
      (firstDeficitRightStaggeredPerm (1 : Fin 4))
...
/-- Exact field-level bridge for the right missing diagonal. -/
theorem firstDeficitRightStaggeredBlock_z_eq_parameterFirstHessian :
    G.firstDeficitRightStaggeredBlock.z =
      parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 1 := by
  change G.firstDeficitRightStaggeredMatrix (3 : Fin 4) 3 =
    parameterFirstHessian P.centralDeficitFamily (1 : Fin 4) 1
  change parameterFirstHessian P.centralDeficitFamily
      (firstDeficitRightStaggeredPerm (3 : Fin 4))
      (firstDeficitRightStaggeredPerm (3 : Fin 4)) =
